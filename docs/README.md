...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-09-08 22:59:47 UTC<br>状态：成功</p>
</section>
...
<p>精读：《SwarmBench: Can Large Language Models Act as Agent Swarm Orchestrators?》（8.0/10）, 《Provably Efficient Federated Reinforcement Learning with Linear Function Approximation and Logarithmic Communication Cost》（8.0/10）</p>
<p>速读：《ARISE-RL: Agentic Rubric-Grounded Iterative Self-Evolution with Reinforcement Learning》（8.0/10）, 《Dual Process Motion Planning》（8.0/10）, 《Evaluating Multimodal LLMs as Generalist Vision-Language-Action Agents for Drone Control: Commanding, Approaching, Tracking and Searching》（8.0/10）</p>
...
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="SwarmBench: Can Large Language Models Act as Agent Swarm Orchestrators?">SwarmBench: Can Large Language Models Act as Agent Swarm Orchestrators?</span></li><li><span class="dpr-home-dashboard-paper-title" title="Provably Efficient Federated Reinforcement Learning with Linear Function Approximation and Logarithmic Communication Cost">Provably Efficient Federated Reinforcement Learning with Linear Function Approximation and Logarithmic Communication Cost</span></li><li><span class="dpr-home-dashboard-paper-title" title="SoK: When Safe Agents Fail Together: The Security of Multi Agent LLM Systems">SoK: When Safe Agents Fail Together: The Security of Multi Agent LLM Systems</span></li></ul>
  </div>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="ARISE-RL: Agentic Rubric-Grounded Iterative Self-Evolution with Reinforcement Learning">ARISE-RL: Agentic Rubric-Grounded Iterative Self-Evolution with Reinforcement Learning</span></li><li><span class="dpr-home-dashboard-paper-title" title="Dual Process Motion Planning">Dual Process Motion Planning</span></li><li><span class="dpr-home-dashboard-paper-title" title="Evaluating Multimodal LLMs as Generalist Vision-Language-Action Agents for Drone Control: Commanding, Approaching, Tracking and Searching">Evaluating Multimodal LLMs as Generalist Vision-Language-Action Agents for Drone Control: Commanding, Approaching, Tracking and Searching</span></li></ul>
  </div>
